...
class Generator(nn.Module):
    def __init__(
        ...
        # E identiy
        convs_e = [ConvLayer(3+10, self.channels[size], 1)]
        ...
        # print('ce',self.convs_e)
        # print('cei',self.convs_ei)
    ...
    def forward(
        ...
        #batch, channel, height, width = styles.shape
        ...
        #styles = torch.cat([styles, stddev], 1)
        ...
        # print('ofs',out_feature.size())
        out = self.conv1(out_feature, latent[:, 0], noise=noise[0])
...
class Discriminator(nn.Module):
    ...
    def forward(self, input, label):
        ...
        output += torch.sum(embedding * out, dim=1, keepdim=True)
        return output,clf